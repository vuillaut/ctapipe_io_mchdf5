...
from numpy import stack, zeros, array, int16, uint64
...
__all__ = ['MCHDF5EventSourceV2Transpose']
HI_GAIN = 0
LO_GAIN = 1
...
class MCHDF5EventSourceV2Transpose(EventSource):
	"""
	...
	def is_compatible(file_path):
		try:
			...
			isCompatible = hfile.title == "R1-V2-PixelSlice"
			hfile.close()
			return isCompatible
		except Exception:
			return False
